...
import AlertContainer from 'react-modal';
        ...
        <div className="container register-form">
            <div className="heading-section">
                <div className="main-heading">
                    Become a <span className="highlightme">Carpool Driver</span> and <span className="highlightme">have some fun!</span> 
                </div>
                <div className="help-text">
                    A great way to get to know people and the city!
                </div>
            </div>
            <div className="row">
